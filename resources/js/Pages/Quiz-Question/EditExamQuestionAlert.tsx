...
const EditExamQuestionAlert = ({ exam_types, exam_years, exam_grades, question }: EditExamQuestionAlertProps) => {
  ...
  const [examYears, setExamYears] = useState<ExamYear[]>(exam_years)
  const [examGrades, setExamGrades] = useState<ExamGrade[]>(exam_grades)
  ...
  useEffect(() => {
    ...
    fetchExamChapters(question.exam_grade_id.toString())
